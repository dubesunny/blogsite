                    ...
                    @if (!$categories->isEmpty())
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td><i role="button" class="fa fa-edit fa-lg openModal text-primary mx-2" data-title="Edit Category"
                                        data-url="{{ route('category.edit', $category->id) }}"></i><i role="button"
                                        class="fa fa-trash fa-lg text-danger deleteHandler"
